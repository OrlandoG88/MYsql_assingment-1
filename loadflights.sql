...
LOAD DATA LOCAL INFILE '/Users/orlandoguerrero/Desktop/flights/flights/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA LOCAL INFILE '/Users/orlandoguerrero/Desktop/flights/flights/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/orlandoguerrero/Desktop/flights/flights/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/orlandoguerrero/Desktop/flights/flights/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/orlandoguerrero/Desktop/flights/flights/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
